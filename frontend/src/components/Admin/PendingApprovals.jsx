            ...
            <div key={item.id} className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    {item.first_name && item.last_name
                      ? <>by <span className="font-medium text-slate-700">{item.first_name} {item.last_name}</span> • </>
                      : null
                    }
              ...
              <div className="flex gap-3 items-center mt-6 flex-col sm:flex-row">
                <input
                  ...
                  className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-[#6d5dfc] focus:ring-1 focus:ring-[#6d5dfc] transition-all placeholder-slate-400 w-full"
