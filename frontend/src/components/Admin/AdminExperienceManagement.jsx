    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900">All Experiences</h1>
                    <p className="text-slate-500 mt-1 text-base">{total} total submissions across all statuses</p>
                </div>
            </div>
            ...
            <div className="bg-white p-2 rounded-xl border border-slate-200 shadow-sm mb-6 flex flex-col md:flex-row gap-2">
                <div className="flex-1 flex items-center px-3 gap-2">
                    ...
                    <input
                        ...
                        className="flex-1 py-2 outline-none text-base text-slate-700 placeholder-slate-400"
                    />
                    {searchInput && (
                        <button
                ...
                <div className="flex items-center gap-2 px-2">
                    <FilterIcon fontSize="small" className="text-slate-400" />
                    <select
                        value={statusFilter}
                        onChange={(e) => setStatusFilter(e.target.value)}
                        className="bg-transparent text-sm font-medium text-slate-600 outline-none px-2 py-2 cursor-pointer hover:bg-slate-50 rounded-lg transition-colors"
                    >
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="p-5 border-b border-slate-200 flex items-center gap-2">
                    <ArticleIcon fontSize="small" className="text-[#6d5dfc]" />
                    <h3 className="text-lg font-bold text-slate-800">Submissions</h3>
                    <span className="ml-auto text-sm text-slate-400">{total} record{total !== 1 ? 's' : ''}</span>
                </div>
                    ...
                    <>
                        <div className="overflow-x-auto">
                            <table className="w-full text-[15px]">
                                <thead>
                                    <tr className="bg-slate-50 text-[12px] font-semibold text-slate-500 uppercase tracking-wider">
                                        ...
                                        <tr key={exp.id} className="hover:bg-slate-50 transition-colors">
                                            <td className="px-6 py-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-full bg-[#6d5dfc]/20 text-[#6d5dfc] flex items-center justify-center font-bold text-sm flex-shrink-0">
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="font-semibold text-slate-900">{exp.company_name}</span>
                                                </div>
                                            </td>
                                            <td className="px-4 py-3 text-slate-600">{exp.role_applied}</td>
                                            <td className="px-4 py-3 text-center">
                                                <span className={`font-semibold capitalize ${RESULT_COLORS[exp.result] || 'text-slate-500'}`}>
                                                    {exp.result === 'pass' ? '✅ Selected' : exp.result === 'fail' ? '❌ Not Selected' : '⏳ Awaiting'}
                                                </span>
                                            </td>
                                            <td className="px-4 py-3 text-center">
                                                <span className={`px-2.5 py-1 rounded-full text-xs font-bold capitalize ${STATUS_COLORS[exp.approval_status] || 'bg-slate-100 text-slate-600'}`}>
                                                    {exp.approval_status}
                                                </span>
                                            </td>
                                            ...
                                            <td className="px-6 py-3 text-center">
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-[#6d5dfc] bg-[#6d5dfc]/10 hover:bg-[#6d5dfc]/20 rounded-lg transition-colors"
                                                >
                    ...
                    <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="bg-slate-50 rounded-lg p-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-slate-900">{selectedExperience.first_name} {selectedExperience.last_name}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-slate-500">Roll Number</label>
                                        <p className="text-slate-900">{selectedExperience.register_number || 'N/A'}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#eef2ff] rounded-lg p-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-slate-900">{selectedExperience.company_name}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-slate-500">Role Applied</label>
                                        <p className="text-slate-900">{selectedExperience.role_applied}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-slate-500">Result</label>
                                        <p className={`font-semibold capitalize ${RESULT_COLORS[selectedExperience.result] || 'text-slate-500'}`}>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-900">{selectedExperience.offer_received ? 'Yes' : 'No'}</p>
                                    </div>
                            ...
                            <div className="bg-green-50 rounded-lg p-4">
                                <h3 className="text-lg font-semibold text-slate-900 mb-3">Questions Asked</h3>
                                        ...
                                        {selectedExperience.rounds.map((round, index) => (
                                            <div key={round.id} className="bg-white rounded-lg p-4 border border-green-200">
                                                                ...
                                                                <div className="flex items-start gap-3">
                                                                    ...
                                                                    <div className="flex-1">
                                                                        ...
                                                                        <div className="flex flex-wrap gap-2 text-xs">
                                                                            {question.category && (
                                                                                <span className="bg-[#e0e7ff] text-[#4338ca] px-2 py-1 rounded">
                                                                                    {question.category}
                                                                                </span>
                                                                            )}
                                                                            {question.difficulty && (
                                                                            ...
                                                                            {question.is_common && (
                                                                                <span className="bg-[#f3e8ff] text-[#7c3aed] px-2 py-1 rounded">
                                                                                    Common
                                                                                </span>
                                                                            )}
                                                                        </div>
                                                                        {question.answer_provided && (
                                                                            <div className="mt-2">
                                                                                ...
                                                                                <p className="text-sm text-slate-800 bg-white p-2 rounded border mt-1">
                                                                                    {question.answer_provided}
                                                                                </p>
                                                                            </div>
                                                                        )}
                                                ...
                                                {round.tips_and_insights && (
                                                    <div className="mt-3">
                                                        <h5 className="text-sm font-medium text-slate-700 mb-1">Tips & Insights:</h5>
                            ...
                            {selectedExperience.overall_feedback && (
                                <div className="bg-[#f5f3ff] rounded-lg p-4">
                                    <h3 className="text-lg font-semibold text-slate-900 mb-3">Overall Feedback</h3>
                                    <p className="text-slate-700 whitespace-pre-wrap">{selectedExperience.overall_feedback}</p>
                                </div>
                            )}
                            ...
                            {selectedExperience.admin_comments && (
                                <div className="bg-[#f5f3ff] rounded-lg p-4">
                                    <h3 className="text-lg font-semibold text-slate-900 mb-3">Admin Comments</h3>
                                    <p className="text-slate-700">{selectedExperience.admin_comments}</p>
                                </div>
                            )}
                            ...
                            {selectedExperience.rejection_reason && (
                                <div className="bg-red-50 rounded-lg p-4">
                                    <h3 className="text-lg font-semibold text-slate-900 mb-3">Rejection Reason</h3>
                                    <p className="text-slate-700">{selectedExperience.rejection_reason}</p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="p-6 border-t border-slate-200 flex justify-end gap-2">
                            ...
                            <button
                                onClick={handleCloseModal}
                                className="px-6 py-2 bg-[#6d5dfc] text-white rounded-lg hover:bg-[#5b47d6] transition-colors"
                            >
                                Close
                            </button>
                        </div>
